...
public class Main {
    public static void main(String[] args) {
        ...
        try {
            ...
            ChatroomsService chatroomsService = context.getBean("chatroomsServiceImpl", ChatroomsService.class);
            Server server = new Server(port, usersService, messagesService, chatroomsService);
